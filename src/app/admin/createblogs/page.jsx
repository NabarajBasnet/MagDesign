...
const CreateBlogs = () => {
    ...
    const blogPostObj = {
        title, introduction, category, subCategory, bodycontent, graphics,
        links, author, date, mentionedpeoples
    }
    ...
    const CreateBlogPost = async(e)=>
    {
        ...
        await fetch('http://localhost:3000/api/blogs',{
            method:"POST",
            body:JSON.stringify({
                title, introduction, category, subCategory, bodycontent,
                graphics, links, author, date, mentionedpeoples
